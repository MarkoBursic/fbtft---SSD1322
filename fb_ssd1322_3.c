...
FBTFT_REGISTER_DRIVER(DRVNAME, "solomon,ssd1322_3", &display);

MODULE_ALIAS("spi:" DRVNAME);
MODULE_ALIAS("platform:" DRVNAME);
MODULE_ALIAS("spi:ssd1322_3");
MODULE_ALIAS("platform:ssd1322_3");

MODULE_DESCRIPTION("SSD1322_3 OLED Driver");
